...
public class OffhandGap extends Module {
    ...
    public void onUpdate() {
        ...
        Item item = shouldTotem() ? Items.TOTEM_OF_UNDYING : Items.GOLDEN_APPLE; // check which item we should use, for OffhandGapple just change Items.END_CRYSTAL to Items.APPLE_GOLDEN
