...
public class AutoCrystalTwo extends Module {//Experimentation CA
    ...
    private Setting<AutoCrystalTwo.HitMode> hitMode = register("HitMode", AutoCrystalTwo.HitMode.Any);
    ...
    private Setting<AutoCrystalTwo.RenderMode> renderMode = register("Render Mode", AutoCrystalTwo.RenderMode.FULL);
    ...
    public void onRender3D(){
        if(Wrapper.getPlayer() != null && Wrapper.getWorld() != null){
            ...
            if(renderPos != null) {
                if (renderMode.getValue().equals(AutoCrystalTwo.RenderMode.FULL)) {
                ...
                } else if (renderMode.getValue().equals(AutoCrystalTwo.RenderMode.OUTLINE)) {
                    RenderUtils.INSTANCE.drawBoundingBox(renderPos, Red / 255f, Green / 255f, Blue / 255f, 0.50f, linewidth.getValue());
                }
            }
        }
